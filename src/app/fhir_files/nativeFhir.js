	...
	(function() {
	    ...
	    var fhir = function(cfg, adapter){
	        ...
	        var Defaults = Middleware(config(cfg, adapter))
	                ...
	                .and($$Header('Accept', (cfg.headers['Accept'] || 'application/json')))
	                .and($$Header('Content-Type', (cfg.headers['Content-Type'] || 'application/json')));
	        ...
	        return decorate({
	            ...
	            create: POST.and(resourceTypePath).end(http),
